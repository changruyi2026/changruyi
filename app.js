...
const APP_VERSION = 'v71'; /* 与 sw.js / index.html 的缓存版本号保持一致；用于「本地旧版本」检测与提示刷新 */
...
const EXP_CATS = ['餐饮', '买菜', '母婴', '交通', '居家', '梁根', '医疗', '还款', '其他', '小红书', '小雨', '芽芽', '红豆', '人情'];

const INC_CATS = ['工资', '副业', '红包', '返款', '蒲公英', '梁根', '其他'];

const CAT_COLOR = { '餐饮': '#E0A98A', '买菜': '#C7B98C', '母婴': '#E8B98C', '交通': '#D8A06A', '居家': '#E9C7A1', '梁根': '#C49A78', '医疗': '#C9A98A', '还款': '#9FA8B0', '其他': '#BCA99B', '小红书': '#E08A6A', '小雨': '#8FA8B8', '芽芽': '#A8BE86', '红豆': '#C97E7E', '人情': '#B8935E', '工资': '#CD8E6B', '副业': '#D3A878', '红包': '#E0A06A', '返款': '#D8A97E', '蒲公英': '#A8B58C' };
